...
- **agy** — the agy CLI on this host; bound as: agy-gemini3.1 (gemini3.1), agy-gemini3.5-flash (gemini3.5-fla…
- **claude** — the claude CLI on this host; bound as: cairn (opus5), casement (opus5), claude-fable5 (fable5), c…
- **codex** — the codex CLI on this host; bound as: aurelia-s88 (gpt5.6-sol), codex-gpt-5.5 (gpt-5.5), codex-gp…
- **opencode** — the opencode CLI on this host; bound as: opencode-deepseek-v4-pro (deepseek-v4-pro), opencode-kim…
- **ycode** — the ycode CLI on this host; bound as: ycode-cascade-claude-x3 (glm-5.2), ycode-cascade-claude-x4 …
