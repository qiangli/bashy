# Agent Shell Evaluation Test: 20260630T071654Z-wrong-cwd-recovery-bashy-v0.4.0-claude-31119
...
- Wall time: 2s
- Tool calls: 0
- Bash command invocations: 1
- Retries: 0
- Retry sleep: 0s
- Rate-limit/API error signals: 0
- Logs: $RUN_ROOT/runs/20260630T071654Z-wrong-cwd-recovery-bashy-v0.4.0-claude-31119/logs
...
```text
2026-06-30T07:16:55Z	$REPO	/workspace	/workspace/.verify.sh /workspace
```
