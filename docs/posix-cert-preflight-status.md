...
| **Apply for VSC-PCTS license** (Open Group) | ✅ **LICENSED + SUITE IN HAND** — countersigned 2026-07-03 (ticket **#279890**); suite downloaded by 2026-07-04; **the run happened** — see `vsc-pcts-run-status.md` | VSC-PCTS2016 OSS v1.4 agreement, signed 2026-06-28, countersigned by The Open Group 2026-07-03. Agreement held privately (personal data — never committed). The 12-month clock started at the suite-access email (early July 2026 → expires ~July 2027), with a 10-day destroy obligation after. Binding terms — suite not redistributable; **results/"passed" claims need their prior written consent (requested, not yet granted)** — see `bashy-v1.0.0-readiness.md` §License terms. |
