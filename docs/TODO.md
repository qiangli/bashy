...
**POSIX frontier**: yash `-p` conformance suite **96%** (2026-06-29; ≥ bash 5.3/5.2, tied with mksh for best of the 10-shell panel) — run `bashy dag DAG.md yash`; details in `docs/cross-shell-conformance-baseline.md` + `docs/yash-conformance-gap.md`
